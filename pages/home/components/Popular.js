...
function Popular() {
    ...
    useEffect(() => {
        ...
        axios.get('https://vast-ruby-cheetah-cape.cyclic.app/api/post/get/all/news?limit=10').then((res) => {
            const allPost = Array.from(res.data['results'])
        ...
        axios.get('https://vast-ruby-cheetah-cape.cyclic.app/api/post/get/all/news?category=politics&limit=10').then((res) => {
            const allPost = Array.from(res.data['results'])
            setPolitics(allPost)
        }).catch((err) => {
            console.log(err)
        ...
        axios.get('https://vast-ruby-cheetah-cape.cyclic.app/api/post/get/all/news?category=news%20update&limit=5').then((res) => {
            const allPost = Array.from(res.data['results'])
            setHealth(allPost)
        }).catch((err) => {
            console.log(err)
        ...
        axios.get('https://vast-ruby-cheetah-cape.cyclic.app/api/post/get/all/news?category=travel&limit=5').then((res) => {
            const allPost = Array.from(res.data['results'])
            setTravel(allPost)
        }).catch((err) => {
            console.log(err)
