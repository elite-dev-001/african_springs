...
function Popular() {
    ...
    useEffect(() => {
        ...
        axios.get('https://africanspringsapi.herokuapp.com/api/post/get/all/news?limit=10').then((res) => {
            const allPost = Array.from(res.data['results'])
        ...
        axios.get('https://africanspringsapi.herokuapp.com/api/post/get/all/news?category=politics&limit=10').then((res) => {
            const allPost = Array.from(res.data['results'])
            setPolitics(allPost)
        }).catch((err) => {
            console.log(err)
